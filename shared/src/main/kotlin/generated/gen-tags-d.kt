...
fun DATALIST.option(classes : String? = null, block : OPTION.() -> Unit = {}) : Unit = consumer.instance("OPTION", { OPTION(attributesMapOf("class", classes), consumer) }).visit(block)
fun DATALIST.option(classes : String? = null, content : String = "") : Unit = consumer.instance("OPTION", { OPTION(attributesMapOf("class", classes), consumer) }).visit({+content})
...
fun DETAILS.legEnd(classes : String? = null, block : LEGEND.() -> Unit = {}) : Unit = consumer.instance("LEGEND", { LEGEND(attributesMapOf("class", classes), consumer) }).visit(block)
...
fun DL.dd(classes : String? = null, block : DD.() -> Unit = {}) : Unit = consumer.instance("DD", { DD(attributesMapOf("class", classes), consumer) }).visit(block)

fun DL.dt(classes : String? = null, block : DT.() -> Unit = {}) : Unit = consumer.instance("DT", { DT(attributesMapOf("class", classes), consumer) }).visit(block)
